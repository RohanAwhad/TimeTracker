...
from src.authentication import signup, hashing
from src.exceptions import UserNameError, EmailError, UserPasswordError, FullNameError
from src.setup import setup_db_env_vars
...
def test_password_pass():
    ...
    valid_passwords_list = ["Reklh_8u7", "fgfs$5647PKL", "674@mhkjKO", "#$@kladjfKL76"]
...
def test_username_pass():
    ...
    valid_usernames_list = ["Max_Payne_21", "maxpayne", "maxpayne097", "SL500"]
